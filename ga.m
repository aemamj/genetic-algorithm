...
CostFounction=@(x) Minone(x); %هزینه

nVar=80; % تعداد متغییر های تصمیم

VarSize=[1 nVar]; %  سایز ماتریکسی که شکل کروموزم را نشان میدهد


 %% پارامت های الگوریتم ژنتیک

MaxIt=100;  % بیشترین تعداد  نسل ها

nPop=20;    % تعداد اعضای جمعیت اصلی
